...
<form class="well loginform" method="post">
    ...
    <p style="margin-top: 0px;" class="login">
        <button type="submit" class="btn btn-primary" name="action" value="login"><i class="icon-signin"></i> Log on
        </button>
    ...
    <p style="margin-top: 0px; display: none;" class="reset">
        <button type="submit" class="btn btn-primary" name="action" value="reset"><i class="icon-envelope"></i> Reset my
            password
        </button>
